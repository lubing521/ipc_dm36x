...
extern	char			*IfName,*IfNameExt,*Cfilename;
...
tsc:
  ...
  snprintf(hostinfo_file_old,sizeof(hostinfo_file_old),DHCP_CACHE_FILE,IfNameExt);
  ...
  snprintf(hostinfo_file,sizeof(hostinfo_file),DHCP_HOSTINFO,IfNameExt);
  snprintf(hostinfo_file_old,sizeof(hostinfo_file_old),""DHCP_HOSTINFO".old",IfNameExt);
