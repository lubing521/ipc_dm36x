...
/***********Kernel Flash分区空间文件*********************/
#define MTD_KERNEL_UPDATE_DEV				"/dev/mtd2"

/***********Rootfs Flash分区空间文件*********************/
#define MTD_ROOTFS_UPDATE_DEV				"/dev/mtd3"

/***********应用程序 Flash分区空间文件*********************/
//#define MTD_SYS_APP				"/dev/mtdblock5"
#define MTD_SYS_APP				"/dev/mtd5"

#define MTD_SYS_DEV							"/dev/mtd6"

#define MTD_SYS_LIB							"/dev/mtd7"

/***********参数区 Flash分区空间文件*********************/
#define MTD_PARAMETER_UPDATE_DEV				"/dev/mtd4"
...
#define		NETCMD_NETWORK_FORMAT_APP	0x00C0	//格式化高清IPC，/dev/mtd5 应用程序区
//格式化完成后，会自动重启前端设备


#define		NETCMD_NETWORK_FORMAT_DEV	0x00C1	//格式化高清IPC，/dev/mtd6 驱动程序区
//格式化完成后，会自动重启前端设备


#define		NETCMD_NETWORK_FORMAT_LIB	0x00C2	//格式化高清IPC，/dev/mtd7 运行库区
//格式化完成后，会自动重启前端设备


#define		NETCMD_NETWORK_FORMAT_TEMP	0x00C3	//格式化高清IPC，/dev/mtd8 临时文件区
//格式化完成后，会自动重启前端设备
...
/***********服务器CPU类型**************/
#define UPDATA_D_DM365  0x00001001
#define UPDATA_D_DM368  0x00001002
#define UPDATA_D_DM385  0x00001003
...
#define UPDATA_D_MTD_DEV  0x00001104	   //设备驱动区
#define UPDATA_D_MTD_LIB  0x00001105	   //运行库区
#define UPDATA_D_MTD_FACTORY  0x00001106	   //出厂基本参数区
#define UPDATA_D_MTD_ALL_THREE  0x00001107	   //统一升级三个区的命令
