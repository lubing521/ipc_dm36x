...
{
    CSL_Status status = CSL_bufInit(&hndl->bscOutBuf, bufInit);
...
{
    CSL_Status status = CSL_bufGetFull(&hndl->bscOutBuf, buf, minBuf, timeout);
...
{
    CSL_Status status = CSL_bufPutEmpty(&hndl->bscOutBuf, buf);
...
{
    CSL_Status status = CSL_bufInit(&hndl->boxcarOutBuf, bufInit);
...
{
    CSL_Status status = CSL_bufGetFull(&hndl->boxcarOutBuf, buf, minBuf, timeout);
...
{
    CSL_Status status = CSL_bufPutEmpty(&hndl->boxcarOutBuf, buf);
