...
#ifndef _DRV_IMGS_AP0101_H_
#define _DRV_IMGS_AP0101_H_
...
extern DRV_ImgsIsifConfig   gDRV_imgsIsifConfig_Common_AP0101;
extern DRV_ImgsIpipeConfig  gDRV_imgsIpipeConfig_Vnfdemo_AP0101;
extern DRV_ImgsIpipeConfig  gDRV_imgsIpipeConfig_Common_AP0101;

extern DRV_ImgsH3aConfig    gDRV_imgsH3aConfig_Appro_AP0101;
extern DRV_ImgsH3aConfig    gDRV_imgsH3aConfig_TI_AP0101;
extern DRV_ImgsH3aConfig    gDRV_imgsH3aConfig_Common_AP0101;

int DRV_imgsReset_AP0101();
int DRV_imgsCalcFrameTime_AP0101(Uint32 fps, Uint32 dataW, Uint32 dataH, Bool binEnable);
int DRV_imgsCalcSW_AP0101(int exposureTimeInUsecs);
int DRV_imgsCalcAgain_AP0101(int aGain);
int DRV_imgsCalcFrameRate_AP0101(int fps);
