...
DRV_ImgsIsifConfig gDRV_imgsIsifConfig_Common = {
  ...
  .ccdcParams = {
    ...
    .colPat = {
      .colPat0 = {
        { CSL_CCDC_COL_PAT_R , CSL_CCDC_COL_PAT_Gr }, //{ CSL_CCDC_COL_PAT_B , CSL_CCDC_COL_PAT_Gb },        
        { CSL_CCDC_COL_PAT_Gb, CSL_CCDC_COL_PAT_B  }, //{ CSL_CCDC_COL_PAT_Gr, CSL_CCDC_COL_PAT_R  },
