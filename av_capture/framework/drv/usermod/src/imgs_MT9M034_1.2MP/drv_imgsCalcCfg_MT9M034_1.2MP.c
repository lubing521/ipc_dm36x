...
int DRV_imgsCalcFrameTime_MT9M034(Uint32 fps, Uint32 dataW, Uint32 dataH, Bool binEnable)
{
    ...
    //printf("MT9M034 dataW = %d \t dataH = %d\n", dataW, dataH);
   ...
   // printf("MT9M034 W = %d \t H = %d\n", pFrame->W, pFrame->H);
    ...
    DRV_imgsCalcFrameRate_MT9M034(fps);
    DRV_imgsCalcSW_MT9M034(pFrame->t_frame/1000);
...
int DRV_imgsInvertSW_MT9M034(int regVal)
{
    DRV_ImgsFrameTime *pFrame = &gDRV_imgsObj.curFrameTime;
