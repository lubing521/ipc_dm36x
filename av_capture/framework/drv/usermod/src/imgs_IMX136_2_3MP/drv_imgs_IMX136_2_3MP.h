...
#ifndef _DRV_IMGS_IMX136_2_3MP_H_
#define _DRV_IMGS_IMX136_2_3MP_H_
...
/*1:sensor on IPNC which is from TI,0:Leopardimaging IPcam*/
#define IMX136_DM368_ON_IPNC_IPCAM  1

#define IMGS_ROW_START_MIN  (40)
#define IMGS_COL_START_MIN  (0)

#ifdef IMX136_LVDS324
#define IMGS_H_PAD          (62)  //(136)
#define IMGS_V_PAD          (30)  //(2)
#else
#define IMGS_H_PAD          (64)  //(136)
#define IMGS_V_PAD          (38)  //(2)
#endif

#define IMGS_H_3M_PAD	(136)
