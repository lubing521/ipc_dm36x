...
int DRV_imgsCalcFrameTime_AR0330(Uint32 fps, Uint32 dataW, Uint32 dataH, Bool binEnable)
{
  ...
  DRV_imgsCalcFrameRate_AR0330(fps);
  DRV_imgsCalcSW_AR0330(pFrame->t_frame/1000);

  pModeCfg->sensorDataWidth   = pFrame->W;
  pModeCfg->sensorDataHeight  = pFrame->H;
  //pModeCfg->validStartX       = IMGS_H_PAD/2+20+20+0+300;
...
int DRV_imgsInvertSW_AR0330(int regVal)
{
  DRV_ImgsFrameTime *pFrame = &gDRV_imgsObj.curFrameTime;
