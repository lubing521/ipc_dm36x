...
#ifndef _DRV_IMGS_AR0330_3MP_H_
#define _DRV_IMGS_AR0330_3MP_H_

#include <drv_imgs.h>
#include <drv_i2c.h>

#define IMGS_H_PAD	        (0)
#define IMGS_V_PAD	        (16)		

#define IMGS_ROW_START_MIN  (40)
#define IMGS_COL_START_MIN  (0)

#if 1
#define IMGS_W_MAX          (2176)
#define IMGS_H_MAX          (1536)
#elif 0
#define IMGS_W_MAX          (2176)
#define IMGS_H_MAX          (1296)
#else
...
#define IMGS_CHIP_ID             (0x2604)

#define AR0331_GLOBAL_GAIN		  0x305E
...
extern DRV_ImgsIsifConfig   gDRV_imgsIsifConfig_Common_AR0330;
extern DRV_ImgsIpipeConfig  gDRV_imgsIpipeConfig_Vnfdemo_AR0330;
extern DRV_ImgsIpipeConfig  gDRV_imgsIpipeConfig_Common_AR0330;

extern DRV_ImgsH3aConfig    gDRV_imgsH3aConfig_Appro_AR0330;
extern DRV_ImgsH3aConfig    gDRV_imgsH3aConfig_TI_AR0330;
extern DRV_ImgsH3aConfig    gDRV_imgsH3aConfig_Common_AR0330;

int DRV_imgsReset_AR0330();
int DRV_imgsCalcFrameTime_AR0330(Uint32 fps, Uint32 dataW, Uint32 dataH, Bool binEnable);
int DRV_imgsCalcSW_AR0330(int exposureTimeInUsecs);
int DRV_imgsCalcAgain_AR0330(int aGain);
int DRV_imgsCalcFrameRate_AR0330(int fps);
