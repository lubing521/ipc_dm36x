...
static void TIAE_config_test(IAE_DynamicParams * aeDynamicParams, int min_exp)
{
    int i = 0;
    aeDynamicParams->exposureTimeRange[i].min = 16666;
    aeDynamicParams->exposureTimeRange[i].max = 16666;
...
void TI_2A_AE_config(IAE_DynamicParams * aeDynamicParams, int min_exp, int step_size)
{
    ...
    //TIAE_config_test(aeDynamicParams, min_exp);
    //return;
