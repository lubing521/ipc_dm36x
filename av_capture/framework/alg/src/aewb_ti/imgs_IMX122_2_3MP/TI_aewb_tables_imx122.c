...
Uint32 TI_YEE_TABLE_IMX122[1024] = {
...
short TI_2A_SetEEValues_imx122(int shift_val) //shift=3 for 1080P/720P, shift=4 for D1
{
  ...
  config.table                    = TI_YEE_TABLE_IMX122;
...
void TI_2A_init_tables_imx122(int width, int height)
{
#ifdef AEWB_PRINTS
