...
int TI_fd_get_config_OV9712(int sensorMode, int* row_time, int* pinp, int* h3aWinHeight)
{
    //return 0;
    int fd_res_support = 1;

    /* multi-resolution flicker detection support */
    if (sensorMode == DRV_IMGS_SENSOR_MODE_1280x720 || sensorMode == DRV_IMGS_SENSOR_MODE_1280x800)
    {
        *row_time = 40;
        *pinp = 72;
        *h3aWinHeight = 22;
...
int TI_fd_trigger_OV9712(IAEWB_Ae *curAe, IAEWB_Ae *nextAe)
{
    int fd_trigger = 0;
