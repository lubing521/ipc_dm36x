...
Uint32 TI_YEE_TABLE_MT9P031[1024] = {
...
short TI_2A_SetEEValues_MT9P031(int shift_val) //shift=3 for 1080P/720P, shift=4 for D1
{
    ...
    config.hpfShift                 = shift_val;//shift_val;
    ...
    config.table                    = TI_YEE_TABLE_MT9P031;
...
void TI_2A_init_tables_MT9P031(int width, int height)
{
#ifdef AEWB_PRINTS
